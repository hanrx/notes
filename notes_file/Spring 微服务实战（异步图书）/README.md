...
* 开发人员的故事：用Spring Boot和Java构建微服务：
    * 从骨架项目开始
    * 引导Spring Boot应用程序：编写引导类
    * 构建微服务的入口：Spring Boot控制器
        * 端点命名问题：
            * 使用明确的URL名称来确立服务所代表的资源。
            * 使用URL来确立资源之间的关系。
            * 尽早建立URL的版本控制方案。

* DevOps工程师的故事：构建运行时的严谨性：
    * 服务装配：打包和部署微服务
    * 服务引导：管理微服务的配置
    * 服务注册和发现：客户端如何与微服务通信
    * 传达微服务的“健康状况”
...
* 将视角综合起来：
    * 架构师——专注于业务问题的自然轮廓。
    * 软件工程师——专注于构建分层服务，服务中的每一层都有离散的职责。
    * DevOps工程师——不仅要关注如何自动化服务的构建和部署，还要关注如何监控服务的健康状况，并在出现问题时做出反应。


## [第3章 使用Spring Cloud配置服务器控制配置](docs/第3章%20使用Spring%20Cloud配置服务器控制配置.md "第3章 使用Spring Cloud配置服务器控制配置")
